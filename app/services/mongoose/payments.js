const Payments = require("../../api/v1/payments/model"); // import model payments
const { checkingImage } = require("./images"); // import checking image

const { NotFoundError, BadRequestError } = require("../../errors");

const getAllPayments = async (req) => {
  let condition = { organizer: req.user.organizer }; // get all payment ambil dari organizer yang login
