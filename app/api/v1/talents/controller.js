// pengertian semua code di sini sama aja ky controller di categories
...
const create = async (req, res, next) => {
  try {
    const result = await createTalents(req); // panggil service createTalents lalu kirim requestnya
